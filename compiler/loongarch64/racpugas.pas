  ...
  interface
    ...
    type
      ...
      tloongarch64gasreader = class(tattreader)
        ...
        procedure BuildSymLA(oper : tloongarch64operand; maybeconst: boolean);
      end;
          ...
          AS_DOT, AS_ID:
            begin
              if actopcode=A_LA_GOT then
                ...
                refaddr:=addr_pcrel;
              BuildSymLA(oper,actasmtoken=AS_ID);
            end;
          AS_END,
          AS_SEPARATOR,
          AS_COMMA: ;
...
*****************************************************************************}
    ...
    procedure tloongarch64gasreader.BuildSymLA(oper : tloongarch64operand; maybeconst : boolean);
      var
        hl : tasmlabel;
        value : tcgint;
      begin
