...
{$endif llvm}
       public
          ...
          function has_double_field(out def1:tdef; out def2:tdef; out offset:integer): integer;
...
{$endif codegen_workaround}
    ...
    function tabstractrecordsymtable.has_double_field(out def1:tdef; out def2:tdef; out offset:integer): integer;
      var
        i,cnt: longint;
